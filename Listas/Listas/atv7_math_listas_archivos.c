/*
    ...
    elementos ordenados crescentemente, insira um número inteiro em L, de forma que esta 
    se mantenha ordenada.

    b. Considerando um arquivo contendo valores inteiros, um por linha, implementar uma função 
    que leia-os e os armazene em uma lista encadeada do tipo TLista, de forma que os elementos 
    fiquem ordenados crescentemente.
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            {
                // Caso o elemento que tentou inserir  esteja presente na lista
                if (retorno == -1)
                {
...
*   Ele começa no primeiro nó (aux1 = L) e percorre a lista até encontrar o valor procurado 
*  (if((aux1->valor) == valorBuscado) ), se encontrar, então já retorna o Nó onde foi encontrado.
*
* Se não, ele vai sair do while e cair no return NULL
*
*/
TLista buscar(TLista L, int valorBuscado)
{
...
// enquanto aux1  for válido, então faça...
// é a mesma coisa que while (aux1 != NULL)
// aux1 é do tipo TLista
        while (aux1)
        {
