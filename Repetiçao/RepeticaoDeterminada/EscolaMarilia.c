...
int main (void) {
    ...
    scanf("%d", &matr);
    Atv = sys(nAlunos,matr);

        /* alunos com nota acima de sete e menor que 3*/
        alunosUp   = Mais7 (notaProva);
        alunosDown = Menos3(notaProva);

        /*somatoria media Turma */
        mediaTurma = Somatorio(nAlunos, somaMedia);
