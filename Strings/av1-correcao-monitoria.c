...
int novaS(char s[], int p, char s1[], char s2[])
{
    // condição para invalidar posição
    // p < 0, p==0,  p == strlen(s)-1
    ...
    */
        ...
        //percorrendo s2 com os caracteres de s da posição p à ultima.
        // variavel i iniciando da posicao p, porem a s2 precisa iniciar do indice 0, logo cria-se um novo contador j
