/*
	...
	Exemplo 5: Remover todas as ocorrências de determinado caracter em uma string.
...
//remove todas as ocorrências de 'caracter' na string 'str', retornando a quantidade de remoções realizadas
int removerCaracter (char str[], char caracter)
{
	//declaração de variáveis
	int i, quant, pos, cont = 0;
	
	//armazenando em 'quant' a quantidade de caracteres da string 'str'
	...
	for (i=0;i<quant;)	
	{
		...
		if (str[i] == caracter) 
		{
			//deslocando os caracteres além daquele que será removido uma posição para a esquerda (incluindo o próprio \0)
