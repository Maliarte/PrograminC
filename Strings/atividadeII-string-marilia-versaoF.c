/*
        ...
        FPR - Fundamentos de Programação Atividade II - Marília Silva 

       Implementar uma função que, dadas duas strings s1 e s2, determinar o número de caracteres comuns entre elas 
       (com o cuidado de que o mesmo caracter não seja contabilizado mais de uma vez).
                            Exemplo 1: 
                            
                            s1: “CEU”  s2: “CADERNO”

                            Retorno da função: 2 caracteres comuns
                            ...
                            s1: “CASA” s2: “CADERNO”
                            Retorno da função: 2 caracteres comuns
                            [neste caso, os caracteres ‘C’ e ‘A’; cuidado para não contabilizar 2 vezes o caracter ‘A’]
